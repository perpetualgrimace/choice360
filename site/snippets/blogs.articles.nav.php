      ...
      <nav class="categories--horizontal sidebar__nav">
        <ul class="inline_list u-unbullet">
          ...
          <li class="sidebar__item">
            <a class="milli <?php if (kirby()->request()->params()->category() == NULL): echo 'is-active_pg'; endif; ?>" href="<?php echo url('blog/articles/') ?>">
              All
            </a>
          </li>
          ...
          <li class="sidebar__item">
            <a class="milli <?php if($category == kirby()->request()->params()->category()): echo 'is-active_pg'; endif; ?>" href="<?php echo url('blog/articles/' . url::paramsToString(['category' => $category])) ?>">
              <?= $category ?>
            </a>
          </li>
          <?php endforeach ?>
